            ...
            <tr>
              <td style="padding: 40px 30px">
                ...
                <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.5; color: #e5e5e7">
                  ...
                  dalam 15 menit sebelum waktu pembayaran Anda habis.
                </p>
      ...
      <tr>
        <td align="center" style="padding: 20px 0">
          ...
          >
            ...
            <tr>
              <td style="padding: 30px 25px">
                <h2 style="margin: 0 0 15px; font-size: 22px; color: #2d3748">
                  Halo, {{namaUser}},
                </h2>
                <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6; color: #4a5568">
                  Kami informasikan bahwa pemesanan tiket Anda telah dibatalkan karena pembayaran
                  tidak berhasil diselesaikan atau telah melewati batas waktu 15 menit.
                </p>
                <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6; color: #4a5568">
                  Jangan khawatir, Anda bisa mencoba memesan kembali. Kursi yang sebelumnya Anda
                  pilih kini telah tersedia kembali untuk umum.
                </p>
            ...
            <tr>
              <td style="padding: 0 25px">
                <h3
                  ...
                  "
                >
                  Detail Pemesanan yang Dibatalkan
                </h3>
                <table
                  width="100%"
                  border="0"
                  cellspacing="0"
                  cellpadding="0"
                  style="background-color: #f7fafc; border: 1px solid #e2e8f0; border-radius: 8px"
                >
                  <tr>
                    <td style="padding: 20px">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td style="padding: 8px 0; font-size: 15px; color: #718096">
                            Jumlah Tiket
                          </td>
                          <td
                            align="right"
            ...
            <tr>
              <td align="center" style="padding: 30px 20px; font-size: 12px; color: #a0aec0">
                <p style="margin: 0">
                  Jika Anda merasa ada kesalahan, silakan hubungi customer service kami.
                </p>
                <p style="margin: 5px 0 0">&copy; 2025 Surya Yudha Cinema. All rights reserved.</p>
              </td>
            </tr>
